...
struct Args {
    ...
    #[arg(long, default_value = "7b-mistral-instruct")]
    which: Which,

    /// GGML file to load, typically a .bin file generated by the quantize command from llama.cpp. You can specify a local path, if not specified the model will be downloaded from the hub based on the --which argument. If you specify a local path, you must also specify a which argument that matches the model.
    #[arg(long)]
    model: Option<String>,

    /// The tokenizer config in json format. You can specify a local path, if not specified the tokenizer will be downloaded from the hub based on the --which argument.
    #[arg(long)]
    tokenizer: Option<String>,

    /// The initial prompt, use 'interactive' for entering multiple prompts in an interactive way
    /// and 'chat' for an interactive model where history of previous prompts and generated tokens
    /// is preserved. e.g --prompt 'My favorite theorem is ', --prompt interactive, --prompt chat. If nothing is specified, the default prompt (My favorite theorem is) is used.
    #[arg(long)]
    ...
    /// Group-Query Attention, the number of groups to use. If not specified, the default value is used based on the model. Default GQA values: 1 for models: L7b, L13b, Vicuna13b, L7bChat, L33b, L33bQ, L13bChat, L7bCode, L13bCode, L34bCode. 8 for models: Mistral7b, Mistral7bInstruct, L70b, L70bChat.
    #[arg(long)]
    gqa: Option<usize>,
}
        ...
        let model_path = match &self.model {
            ...
            None => {
                let (repo, filename) = match self.which {
                    ...
                    Which::Vicuna13b => ("lmsys/vicuna-13b-v1.5-16k", "pytorch_model-00003-of-00003.bin"),
                    Which::L33b => ("TheBloke/vicuna-33B-GGUF", "vicuna-33b.Q5_K_M.gguf"),
                    Which::L33bQ => ("TheBloke/vicuna-33B-GGUF", "vicuna-33b.Q6_K.gguf"),
...
fn main() -> anyhow::Result<()> {
    ...
    println!("A model was built with {:?} parameters", args);
